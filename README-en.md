<p align="center">
    ...
    <h1 align="center">cloud-mail-global</h1>
    <p align="center">Ultimate enhanced Cloudflare Workers email service — original features + Plus capabilities deeply merged</p>
    <p align="center">
...
This project deeply merges [maillab/cloud-mail](https://github.com/maillab/cloud-mail) and [AndrewYukon/cloud-mail-plus](https://github.com/AndrewYukon/cloud-mail-plus). It uses the Plus edition as the mainline, restores original features that had drifted out such as blacklist filtering, AI verification-code extraction, and login-page behavior, and packages the result as the `cloud-mail-global` ultimate enhanced edition. Thanks to both original authors for their open-source work.
...
- State saved to `.cloud-mail-global-deploy.env` (gitignored, contains the JWT secret)
...
All features from [maillab/cloud-mail](https://github.com/maillab/cloud-mail) are preserved, with `cloud-mail-plus` enhancements layered on top:
