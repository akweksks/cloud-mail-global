const en = {
	...
	scheduleTimeRequired: 'Scheduled send time is required',
	scheduleTimeFuture: 'Scheduled send time must be in the future',
	...
	regKeyBatchCountLimit: 'Batch size cannot exceed {{count}}',
	regKeyGenerateFail: 'Failed to generate invite codes. Please try again',
	...
	roleDescriptions: {
		...
		"Basic mailbox permissions": "Basic mailbox permissions",
		"只有普通使用权限": "Basic mailbox permissions"
	},
	perms: {
		"Email": "Email",
		...
		"All email": "All email",
		"View all email": "View all email",
		"Delete all email": "Delete all email",
		...
		"View registration keys": "View registration keys",
		"Add registration keys": "Add registration keys",
		"Delete registration keys": "Delete registration keys",
