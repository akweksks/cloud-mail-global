            ...
            <div class="card-content">
              <div class="concerning-item">
                ...
                <el-badge is-dot :hidden="!hasUpdate">
                  <el-button @click="jump(PROJECT_RELEASES_URL)">
                    {{ currentVersion }}
                    <template #icon>
              ...
              <div class="concerning-item">
                ...
                <div class="community">
                  <el-button @click="jump(PROJECT_REPO_URL)">
                    Github
                    <template #icon>
                      <Icon icon="codicon:github-inverted" width="22" height="22"/>
                    </template>
                  </el-button>
                  <el-button @click="jump(PROJECT_SUPPORT_URL)">
                    {{ $t('buyMeCoffee') }}
                    <template #icon>
              ...
              <div class="concerning-item">
                <span>{{ $t('help') }} : </span>
                <el-button @click="jump(PROJECT_DOC_URL)">
                  {{ t('document') }}
                  <template #icon>
...
function getUpdate() {
  if (!PROJECT_RELEASE_API_URL || getUpdateErrorCount > 5 || !getUpdateErrorCount) return
  axios.get(PROJECT_RELEASE_API_URL).then(({data}) => {
