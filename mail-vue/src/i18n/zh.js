const zh = {
    ...
    addRegKey: '添加注册码',
    regKey: '注册码',
    regKeyModeReusable: '单个注册码',
    regKeyModeBatch: '批量一次性码',
    availableCount: '可用次数',
    batchRegKeyCount: '生成数量',
    generatedRegKeys: '已生成注册码',
    copyAll: '全部复制',
    noCodeFound: '没有任何注册码',
    useHistory: '使用记录',
    date: '时间',
    ...
    bcc: '密送',
    separateSend: '分别发送',
    recipientPastePlaceholder: '输入或粘贴邮箱，支持多个地址',
    ccPastePlaceholder: '添加抄送人',
    bccPastePlaceholder: '添加密送人',
    recipientCountBadge: '{count} 个',
    recipientTotalCount: '共 {count} 个邮箱',
    recipientToCount: '主送 {count}',
    recipientCcCount: '抄送 {count}',
    recipientBccCount: '密送 {count}',
    randomPrefix: '随机生成',
    prefixGenerateMode: '前缀生成方式',
    prefixModeAlnum: '字母数字',
    prefixModeName: '全球人名',
    prefixModeNameNumber: '人名数字',
    delivered: '发送成功',
    complained: '被标记为垃圾',
    delayed: '发送被延迟',
    bounced: '发送失败',
