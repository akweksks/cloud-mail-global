const en = {
    ...
    regKey: 'Invite Code',
    regKeyModeReusable: 'Single reusable code',
    regKeyModeBatch: 'Batch one-time codes',
    availableCount: 'Available count',
    batchRegKeyCount: 'Batch size',
    generatedRegKeys: 'Generated invite codes',
    copyAll: 'Copy all',
    ...
    cc: 'Cc',
    bcc: 'Bcc',
    separateSend: 'Send separately',
    recipientPastePlaceholder: 'Enter or paste email addresses',
    ccPastePlaceholder: 'Add Cc recipients',
    bccPastePlaceholder: 'Add Bcc recipients',
    recipientCountBadge: '{count}',
    recipientTotalCount: '{count} emails total',
    recipientToCount: 'To {count}',
    recipientCcCount: 'Cc {count}',
    recipientBccCount: 'Bcc {count}',
    randomPrefix: 'Random',
    prefixGenerateMode: 'Prefix generation mode',
    prefixModeAlnum: 'Letters + numbers',
    prefixModeName: 'Global names',
    prefixModeNameNumber: 'Name + numbers',
    delivered: 'Delivered',
    ...
    emptyBatchCountMsg: 'Batch size cannot be empty',
    ...
    invalidRecipientMsg: 'Ignored unrecognized email addresses: {msg}',
    ...
    noScheduledSendAttMsg: 'Scheduled sending does not support attachments yet',
    scheduleSend: 'Schedule',
    scheduleSendTitle: 'Schedule send',
    scheduleTime: 'Send time',
    scheduleConfirm: 'Schedule send',
    scheduleSuccessMsg: 'Scheduled',
    schedulePendingMsg: 'This email will be sent at {time}',
    scheduleTimeRequired: 'Please choose a send time',
    scheduleTimeFuture: 'Send time must be in the future',
